...
const UserAvatar = memo(({ user }: { user: UserType }) => (
  <>
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-xs text-muted-foreground">Hey there! I'm whop</p>
    </div>
  </>
));
...
const ChatUserItem = memo(({ user, isLoading, disabled, onClick }: { user: UserType; disabled: boolean; isLoading: boolean; onClick: (id: string) => void }) => (
  <button
